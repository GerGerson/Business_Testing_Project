...
<body>
  ...
  <div class="services-block content content-center" id="services">
    <div class="container">
	  ...
	  <div class="row">
			<a href="/gas_desc" class="btn blue">了解更多</a>
	  </div>
    </div>
  </div>
  <!-- Services block END -->
				...
				<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 item">
					<div class="form-group">
						<div class="contact-item">
							...
							<span id="name-error" class="contact-error">請輸入姓名！</span>
					...
					<div class="form-group">
						<div class="contact-item">
							...
							<span id="method-error" class="contact-error">請輸入聯絡方法！</span>
					...
					<div class="form-group">
						<div class="contact-item">
							...
							<span id="content-error" class="contact-error">請輸入留言內容！</span>
