    ...
    <div class="container">
	  ...
	  <div class="row">
		...
		<div class="col-md-8 col-md-offset-2">
			...
			<p style="text-align: left; font-size:20px">
				甲醛是最常見的室內空氣污染物。
				<br/><br/>
				大多數源頭多來自常用的建築及裝修物料中的甲醛樹脂。
				<br/><br/>
				甲醛樹脂十分普遍用於以上物料(例如:纖維板、壓製木產品、發泡膠隔熱層、黏著劑、織物、地氈等)。
			</p>
			</div>
        </div>
      </div>
	  ...
	  <div class="row">
		...
		<div  class="col-md-8 col-md-offset-2">
			...
			<p style="text-align: left; font-size:20px">
				甲醛會緩慢持續放出釋放數年以上。
				<br/><br/>
				人類如吸入一定量甲醛,更會對咽喉和眼睛鼻腔等產生刺激性作用。
				<br/><br/>
				美國國家毒理學項目於2011已經將甲醛列入“已知的人類致癌物”清單之中。
				<br/><br/>
				美國國家研究委員會於2014年明確指出甲醛是一種人類致癌物。
			</p>
			</div>
        </div>
	  </div>
	  ...
	  <div class="row">
		...
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="col-md-7">
			<p style="text-align: left; font-size:20px">
				歐洲各國早已定明室內甲醛量不應超過0.08pp。
				<br/><br/>
				美國於2012年更進一步收緊建築及裝修用之複合木質品標準不可超過0.05ppm。
				<br/><br/>
				香港亦參考世界衛生組織標準定立指標,分別「卓越級」- 少於0.24ppm、「良好級」- 少於0.24ppm。
			</p>
			</div>
        </div>
	  </div>
	  ...
	  <div class="row">
		...
		<div class="col-md-8 col-md-offset-2">
			...
			<p style="text-align: left; font-size:20px">
				坊間有很多方法去除甲醛,但都是被誤解的。
				<br><br>
				除去剌鼻的味道,其實甲醛並未消失,並持續地釋放。
				<br><br>
				最好的方法當然是經常保持窒內空氣流通,用低甲醛物料,或請專人上門提供除甲醛服務。
			</p>
			</div>
        </div>
	  </div>
