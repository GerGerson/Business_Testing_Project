...
class ProblemController extends BaseController {
	public function photo($event, $id){
		...
		$arrDesc[6] = array('大門鐵閘門口外面牆空隙(跟進項目)<br>同樣因拆卸鐵閘已留下一大洞孔; 應用石英泥先作修補為妥(上次應已報告)',
							'大廳原大廈開口電話位置(跟進項目)<br>只用英泥馬虎填補, 並已批灰, 請向師傅查詢(上次應已報告)',
							'鋁窗(跟進項目)<br>留下4個窗孔未裝上(大廳右上,廁所,主人房及客房); 應保留原先窗口玻璃或用木板裝上, 待新玻璃送到才替換, 避免雨水入屋 (上次應已報告)',
							'廁所浴缸位置(跟進項目)<br>已做防漏工作並完工, 但因用帆布蓋上, 有待跟進',
							'全屋牆身(跟進項目)<br>牆漆尚未鏟清就已批灰, 日後可能會出現油漆剝落 (已出現裂/坑紋, 日後上油一定不能貼伏, 請重新批灰)',
							'主人房(跟進項目)<br>牆身出現裂縫情況, 因廚房加裝電位而鑿穿主人房牆壁, 通知裝修師傅修補妥當(上次應已報告)',
							'主人房與客房門框空隙(跟進項目)<br>門框與牆出現頗大空隙, 相信裝修師傅會等到新門到達才處理, 有待跟進',
							'窗檯雲石(跟進項目)<br>新裝雲石尚未修補兩側, 甚至底部執漏',
							'廚房喉管外露(跟進項目)<br>廚房已鋪地磚',
							'廁所窗外(跟進項目)<br>發現窗外喉管開關位被英泥弄上, 請通知裝修師傅清理(上次應已報告)',
							'廚房左上角牆身(跟進項目)<br>左上角牆磚已被吊櫃遮掩, 但吊櫃內部切口不齊, 請通知裝修師傅處理',
							'廚房新做鋪磚(跟進項目)<br>發現入門位上面尚未鋪磚, 未知是否廚房假天花位置, 有待跟進',
							'入牆櫃位置(跟進項目)<br>因放置雜物已未批灰, 有待跟進',
							'大門位置(新)<br>發現門框有空隙, 請通知裝修師傅處理',
							'門與牆壁(新)<br>發現每道門質牆壁之間缺少了門擋(可防止開門時撞花牆壁)',
							'廁所企缸位置及地面(新)<br>發現鋪完地磚, 斜度並不是流向渠口, 請通知裝修師傅處理',
							'櫃門與牆壁(新)<br>發現櫃門與牆壁之間太貼, 容易弄到牆壁, 應加防撞膠最好',
							'磁磚角位(新)<br>由於本身磁磚面不是平, 所以應用多些白英泥封好, 以免割傷',
							'廁所及廚房門口(新)<br>尚未用地磚鋪好, 請通知裝修師傅處理',
							'廚房窗與吊櫃之間(新)<br>由廚房伸出窗外向上望, 發現尚未批灰, 請通知裝修師傅處理',
							'廚房吊櫃與牆壁(新)<br>廚房吊櫃與牆壁尚有空隙, 請通知裝修師傅處理',
							'地磚縫隙(新)<br>地腳縫口尚未用做好, 請通知裝修師傅處理'
		);
